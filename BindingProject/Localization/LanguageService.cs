    ...
    public class LanguageService : ILanguageService
    {
        ...
        private void LoadTranslations()
        {
            ...
            var ruTranslations = new Dictionary<string, string>
            {
                ...
                { "TriggersView_Example1_Title", "Кнопка с триггером на наведение" },
                { "TriggersView_Example1_Hint", "✓ IsMouseOver: меняет цвет, размер, шрифт" },
                { "TriggersView_Example2_Title", "CheckBox с триггером на IsChecked" },
                { "TriggersView_Example2_Hint", "Цвет фона меняется при отметке" },
                { "TriggersView_Example3_Title", "TextBox с триггером на IsFocused" },
                { "TriggersView_Example3_Hint", "✓ При фокусе: синяя рамка, голубой фон" },
                { "TriggersView_EventExample1_Title", "Кнопка с анимацией при клике" },
                { "TriggersView_EventExample1_Hint", "✓ При клике: мигает и сжимается" },
                { "TriggersView_EventExample2_Title", "Анимация при наведении" },
                { "TriggersView_EventExample3_Title", "Анимация при загрузке" },
                { "TriggersView_EventExample3_LargeTitle", "⚡ Триггеры в действии ⚡" },

                // Label для цены и итога
                { "Label_PriceColon", "Цена:" },
                { "Label_QuantityColon", "Количество:" },
                { "Label_NameColon", "Название:" },
                { "Label_TotalAllCapsColon", "ИТОГО:" },
            };
            ...
            var enTranslations = new Dictionary<string, string>
            {
                ...
                { "TriggersView_Example1_Title", "Button with hover trigger" },
                { "TriggersView_Example1_Hint", "✓ IsMouseOver: changes color, size, font" },
                { "TriggersView_Example2_Title", "CheckBox with IsChecked trigger" },
                { "TriggersView_Example2_Hint", "Background color changes when checked" },
                { "TriggersView_Example3_Title", "TextBox with focus trigger" },
                { "TriggersView_Example3_Hint", "✓ On focus: blue border, light blue background" },
                { "TriggersView_EventExample1_Title", "Button with click animation" },
                { "TriggersView_EventExample1_Hint", "✓ On click: flashes and shrinks" },
                { "TriggersView_EventExample2_Title", "Animation on hover" },
                { "TriggersView_EventExample3_Title", "Animation on load" },
                { "TriggersView_EventExample3_LargeTitle", "⚡ Triggers in action ⚡" },

                // Labels
                { "Label_PriceColon", "Price:" },
                { "Label_QuantityColon", "Quantity:" },
                { "Label_NameColon", "Name:" },
                { "Label_TotalAllCapsColon", "TOTAL:" },
            };
